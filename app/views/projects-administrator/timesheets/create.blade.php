...
@section('content')
    ...
    <div class="row">
        ...
        @endif
        {{ Form::open(array('route'=>'project_admin.timesheets.store','role'=>'form','class'=>'form-horizontal')) }}
            ...
            <div class="form-group">
                <div class="col-sm-offset-2 col-sm-10">
                    ...
                    <a href="{{ URL::route('project_admin.timesheets.index',['date'=>$dt_request]) }}" class="btn btn-default">Отмена</a>
                </div>
            </div>
        {{ Form::close() }}
        </div>
