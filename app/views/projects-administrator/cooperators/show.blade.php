...
@section('content')
    <div class="jumbotron">
        ...
        <a role="button" href="{{ URL::route('project_admin.cooperators.edit',$user->id) }}" class="btn btn-primary btn-sm">Редактировать</a>
        {{ Form::open(array('route'=>array('project_admin.cooperators.destroy',$user->id),'method'=>'DELETE','style'=>'display:inline-block')) }}
